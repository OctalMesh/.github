...
This document defines the default support policy for OctalMesh repositories.

It applies to repositories that do not provide their own `SUPPORT.md`. If a
repository includes a local support policy, that document takes precedence.
